      ...
      <div className='my-project-container'>
        <div className='project-cards flex-project-cards-1'>
          ...
          <div className='project-card-body'>
            ...
            <p>Java script, Django, Python, Html, Css, React.js, Scss, 3rd party libraries</p>
            <h2>Descriptions</h2>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Praesentium, itaque ipsam. In eum magnam, harum sed, ipsa eius perspiciatis doloribus sequi adipisci delectus debitis? Temporibus autem minus facere nostrum inventore.</p>
          </div>
        ...
        <div className='project-cards'>
          ...
          <div className='project-card-body'>
            ...
            <p>Java script, Django, Python, Html, Css, React.js, Scss, 3rd party libraries</p>
            <h2>Descriptions</h2>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora impedit maiores tenetur non fugiat quaerat quisquam error possimus id earum iste saepe, qui ducimus modi officia asperiores repudiandae. Laudantium, reiciendis! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Praesentium, itaque ipsam. In eum magnam, harum sed, ipsa eius perspiciatis doloribus sequi adipisci delectus debitis? Temporibus autem minus facere nostrum inventore.</p>
          </div>
          <div className='project-card-footer'>
            <a href="https://github.com/TBuscemi/" target='_blank'><i class="fa-brands fa-github fab"></i></a>
            <a>
